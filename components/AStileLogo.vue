...
const maskPath = "M0 1080V270Q180 220 360 270T720 270T1080 270V1080H0Z";
const finalPath = "M0 1080V0H1080V1080H0Z";

const yPosition = useSpring(1080, {
  stiffness: 20,
  damping: 15,
  mass: 1
});
...
<template>
  <motion.svg width="1080" height="1080" viewBox="0 0 1080 1080" fill="none" xmls="http://www.w3.org/2000/svg">
    <defs>
      <mask id="fillMask">
        <motion.path :d="maskPath" fill="white" :style="{ y: yPosition }">
          <animate
            attributeName="d"
            dur="1s"
            :values="
              [
                'M0 1080V270Q180 220 360 270T720 270T1080 270V1080H0Z',
                'M0 1080V270Q180 320 360 270T720 270T1080 270V1080H0Z',
                'M0 1080V270Q180 220 360 270T720 270T1080 270V1080H0Z',
                finalPath
              ].join(';')
            "
